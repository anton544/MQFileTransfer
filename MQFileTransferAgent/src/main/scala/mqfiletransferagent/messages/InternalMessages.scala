...
case class FileReadVerify(transferid: String, path: String, targetPath: String, targetCommandQueue: String, targetDataQueue: String)
case class FileWriteSuccess(transferid: String, path:String, sourceDataQueue: String)
case class FileReadSuccess(transferid: String, targetPath: String, targetCommandQueue: String, targetDataQueue: String)
